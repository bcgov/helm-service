...
const main = async () => {
  ...
  const destChartYaml = await fs_promises.readFile(`./${destination_repo}/charts/app/Chart.yaml` || `./${destination_repo}/charts/${destination_repo}/Chart.yaml`);
  ...
  await fs_promises.writeFile(`./${destination_repo}/charts/app/Chart.yaml` || `./${destination_repo}/charts/${destination_repo}/Chart.yaml`, newDestChartYaml);
}
await main();
